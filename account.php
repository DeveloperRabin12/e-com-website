           ...
           <div class=" text-center mt-1 pt-1 col-lg-6 col-md-12 col-sm-12">
              <form id="account-form" action="">
                ...
                <div>
                  ...
                  <input type="password" class="form-control" name="password" id="account-password" required> 
                </div>

                <div>
                  <label for="">Confirm Password</label>
                  <input type="password" class="form-control" name="confirmpassword" id="account-password-confirm" required> 
                </div>
